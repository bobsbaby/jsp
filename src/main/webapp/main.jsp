...
<!-- Bootstrap core CSS -->
<script src="<%=request.getContextPath()%>/bootstrap/js/bootstrap.min.js"></script><!-- Custom styles for this template -->
	...
	<div class="container-fluid">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="#">Help</a></li>
				<%
					// 로긴컨트롤러에서 설정한 이름, object 타입이므로 형변환 한다.
...
<div class="col-sm-3 col-md-2 sidebar">
	<ul class="nav nav-sidebar">
									<!-- a tag: get method -->
		<li class="active"><a href="<%=request.getContextPath() %>/userList">유저리스트<span class="sr-only">(current)</span></a></li>
